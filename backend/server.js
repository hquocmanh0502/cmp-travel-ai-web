...
app.get('/api/feedback', async (req, res) => {
  try {
    ...
    console.log(`📊 Found ${feedbacks.length} website feedback`);
    ...
    console.log('✅ Sending transformed feedback to frontend');
    console.log('📝 Sample:', transformedFeedbacks[0]);
...
app.post('/api/feedback', async (req, res) => {
  try {
    ...
    console.log('📥 Received feedback submission:', { name, email, rating, category, userId });
    ...
    console.log('💾 Saving feedback with data:', feedbackData);
    ...
    try {
      ...
      console.log('⚠️ Sentiment analysis not available:', serviceError.message);
    }
